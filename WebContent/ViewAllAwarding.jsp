...
<table border="1" align="center" bordercolor="wheat" bgcolor="#FFFFFF" width="719" height="20%">
  ...
  <br><br>
    <%
            CoreHash aCoreHash=new QuatationDAO().getAwardings();
	...
	<tr>
       ...
       <th><div align="center" class="Title">Receiptdate</div></th>
        ...
        <td bgcolor="#C3D7BA"><div align="center"><span class="style7"><%=aQuatation.getTenderName()%></span></div></td>
        <td bgcolor="#C3D7BA"><div align="center"><span class="style7"><%=aQuatation.getItemName()%></span></div></td>
        ...
        <td bgcolor="#C3D7BA"><div align="center"><span class="style7"><%=aQuatation.getReceiptdate()%></span></div></td>
     ...
     <%}
      ...
      {%>
         <tr>
         <td height="24" colspan="6"><div align="center" class="style7"><strong>No Awardings Available</strong></div></td>
         </tr>
      <%
      }
       %>
