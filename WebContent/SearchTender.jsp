...
<!-- options --></TD>
  ...
  <TR>
    ...
    <br><br><br><br>	
     <form action="ViewAllQuatationsByTenderID.jsp" method="post" name="additem" onSubmit="">
 ...
 <tr>                  
                     <td >TenderName</td>
                      ...
                      <%CoreHash bCoreHash=new TenderPostDAO().getAllTenderPosts();
                      Enumeration e1=bCoreHash.keys();
					   while(e1.hasMoreElements())
					   {
					   Integer i1=(Integer)e1.nextElement();
					   TenderPost aTenderPost=(TenderPost)bCoreHash.get(i1);
			                      
                      %>
                      <option value="<%=aTenderPost.getTenderid() %>"><%=aTenderPost.getTendername() %></option>
                       <%} %></select></td>
                      </tr>
