...
<table border="1" align="center" bordercolor="wheat" bgcolor="#FFFFFF" width="719" height="20%">
  ...
  <br><br>
    <%
            CoreHash aCoreHash=new QuatationDAO().getQuatations();
	...
	<tr>
     ...
     <%}
      ...
      {%>
         <tr>
         <td height="24" colspan="6"><div align="center" class="style7"><strong>No Quatations Available</strong></div></td>
         </tr>
      <%
      }
       %>
