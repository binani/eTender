...
<table border="1" align="center" bordercolor="wheat" bgcolor="#FFFFFF" width="719" height="20%">
  ...
  <br><br>
    ...
    if(!tenderid.equals(null))
    {
    int tenderID=Integer.parseInt(tenderid);
            CoreHash aCoreHash=new QuatationDAO().getQuatations(tenderID);
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Quatations by TenderID Details</h2></tr>
	<tr>
         	...
         	<tr bgcolor="#CCCCCC">
        <th><div align="center" class="Title">QuatationID</div></th>
        <th><div align="center" class="Title">TenderID</div></th>
        <th><div align="center" class="Title">SupplierName</div></th>
        <th><div align="center" class="Title">DDNo</div></th>
       <th><div align="center" class="Title">BidPostDate</div></th>
        <th><div align="center" class="Title">Quantity</div></th>
        <th><div align="center" class="Title">spesification</div></th>
        <th><div align="center" class="Title">PriceBid</div></th>
      </tr>
		   <%Enumeration e=aCoreHash.keys();
		   while(e.hasMoreElements())
		   {
		   Integer i=(Integer)e.nextElement();
		   Quatation aQuatation=(Quatation)aCoreHash.get(i);
		   
		   
		   %>
		    <tr bgcolor="#CEC9FA">
        
        <td bgcolor="#C3D7BA"><div align="center"><span class="style7"><%=aQuatation.getQuatatonID()%></span></div></td>
        <td bgcolor="#C3D7BA"><div align="center"><span class="style7"><%=aQuatation.getTenderID()%></span></div></td>
        <td bgcolor="#C3D7BA"><div align="center"><span class="style7"><%=aQuatation.getSuppierName()%></span></div></td>
        <td bgcolor="#C3D7BA"><div align="center"><span class="style7"><%=aQuatation.getDDNo()%></span></div></td>
        <td bgcolor="#C3D7BA"><div align="center"><span class="style7"><%=aQuatation.getBidPostDate()%></span></div></td>
        <td bgcolor="#C3D7BA"><div align="center"><span class="style7"><%=aQuatation.getQuantity()%></span></div></td>
        <td bgcolor="#C3D7BA"><div align="center"><span class="style7"><%=aQuatation.getSpesification()%></span></div></td>
        <td bgcolor="#C3D7BA"><div align="center"><span class="style7"><%=aQuatation.getPricebid()%></span></div></td>
       <td bgcolor="#C3D7BA"><div align="center"><span class="style7"><a href="./TenderAwardAction?quatationID=<%=aQuatation.getQuatatonID()%>">AcceptTender</span></div></td>
     ...
     <%}
      ...
      {%>
         <tr>
         <td height="24" colspan="6"><div align="center" class="style7"><strong>No Quatations for this TenderID Available</strong></div></td>
         </tr>
      <%
      }}
       %>
    ...
    <a href="SearchTender.jsp">Search Again</a></td></tr></table>
